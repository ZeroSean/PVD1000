...
#define RESEND_DURATION		(30 * 1000) //60s
#define HEART_DURATION		(60 * 1000)
#define NEXT_SEND_DURATION	(10)			//普通发送数据间隔
...
#define NC_HEART_PACKET		0x05	//心跳
#define NC_WAITING_CONNECT	0xff
