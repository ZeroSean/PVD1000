...
#define	DW_SPI_CS		PBout(12)	//chip select

#define DW_NSS			GPIO_Pin_12
#define DW_SCK			GPIO_Pin_13
#define DW_MISO			GPIO_Pin_14
#define DW_MOSI			GPIO_Pin_15
#define DW_SPI_GPIO		GPIOB

#define DW_RESET			GPIO_Pin_0
#define DW_RESET_GPIO		GPIOB
#define DW_RESET_IRQn		EXTI0_IRQn
#define DW_RESET_IRQLINE	EXTI_Line0

#define DW_WUP			GPIO_Pin_1
...
//unused!
#define DW_P7			GPIO_Pin_12
#define DW_P7_GPIO		GPIOC

#define DW_PHA			GPIO_Pin_7
#define DW_POL			GPIO_Pin_6
